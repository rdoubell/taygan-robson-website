    ...
    <section id="services" className="section-pad bg-white" ref={ref}>
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          >
            A complete performance system, delivered with clinical precision.
          </motion.p>
          <motion.span
            ...
            return (
              ...
              >
                ...
                <div className={`flex flex-col justify-center px-8 py-10 lg:px-12 bg-white group-hover:bg-[#FAFAF9] transition-colors duration-300 ${imageRight ? "lg:order-2" : "lg:order-1"}`}>
                  <span className="text-[11px] tracking-[0.3em] text-[#3D7A57]/60 font-mono mb-4" style={{ fontFamily: "'DM Mono', monospace" }}>{svc.num}</span>
                  ...
                  <a href="#contact" className="self-start flex items-center gap-3 text-[11px] tracking-[0.2em] uppercase text-[#3D7A57] font-medium hover:gap-5 transition-all duration-200">
                    Learn More <span className="w-6 h-px bg-[#3D7A57] inline-block" />
                  </a>
                </div>
              </motion.div>
            )
