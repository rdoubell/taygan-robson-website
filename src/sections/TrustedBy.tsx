            ...
            {[...logos, ...logos].map((_, i) => (
              <CarouselItem key={i} className="pl-0 basis-auto">
                <div className="flex flex-col items-center justify-center gap-2 px-10 py-7 border-r border-[#E2E8E4] cursor-default min-w-[200px]">
                  <div className="w-24 h-8 border border-dashed border-[#3D7A57]/25 bg-[#F7F7F5] flex items-center justify-center">
                    <span className="text-[9px] tracking-[0.2em] uppercase text-[#3D7A57]/40" style={{ fontFamily: "'DM Mono', monospace" }}>Insert Logo</span>
                  </div>
                </div>
              </CarouselItem>
            ))}
