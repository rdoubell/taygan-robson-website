...
const faqs = [
  ...
  },
  {
    ...
    a: "The initial 1INC Consultation is a comprehensive first assessment — it establishes your baseline, produces the written report, and sets the programme direction. A Follow-Up is a 45-minute focused check-in for returning and existing clients only, used to review progress against the plan and make adjustments. A written report is delivered within 7 days. Follow-ups are not available without a prior consultation.",
  },
  {
  ...
  },
  {
    ...
    a: "The written Specialised Report is delivered within 7 working days of your consultation. Follow-up written reports are delivered within 7 days.",
  },
  {
